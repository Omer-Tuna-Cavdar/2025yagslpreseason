...
public class RobotContainer
{
  ...
  private void configureBindings()
  {
    ...
    if (DriverStation.isTest())
    {
      ...
      driverController.square().whileTrue(drivebase.sysIdDriveMotorCommand());
      driverController.circle().whileTrue(Commands.runOnce(drivebase::lock, drivebase).repeatedly());
      ...
      driverController.povUp().whileTrue(drivebase.centerModulesCommand());
      ...
      driverController.circle().whileTrue(
          drivebase.driveToPose(
              new Pose2d(new Translation2d(4, 4), Rotation2d.fromDegrees(0)))
                              ...
                              driverController.povUp().whileTrue(Commands.none());
